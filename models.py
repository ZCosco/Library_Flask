...
class Book(db.Model):
    ...
    def __init__(self, isbn, author_name, title, book_length, year_of_release, in_stock, user_token, id=''):
        self.id = self.set_id()
        self.isbn = isbn
...
class BookSchema(ma.Schema):
    class Meta:
        fields = ['id', 'isbn', 'author_name', 'title', 'book_length', 'year_of_release', 'in_stock']
